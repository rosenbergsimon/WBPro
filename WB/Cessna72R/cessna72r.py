...
class C72R(tk.CTkToplevel):
    ...
    # this function point to calculation.py class, and does all the calculating work/making of the images. Also
    ...
    # right_data is the final weights/success/fail of the weight and balance for the upload frame.
    def new_right(self):
