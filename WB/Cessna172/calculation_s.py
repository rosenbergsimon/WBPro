...
class CalculationS:
    ...
    def check_wb(self):
        ...
        if self.ramp_weight > 2558:
            ramp_weight_good = False
        if self.takeoff_weight > 2550:
    ...
    def check_in_limits(self, weight, arm):
        ...
        if weight < 1950 and arm < 35:
            return 0
        if (1950 <= weight <= 2550) and 41 <= arm <= 47.3:
            return 1
        if arm > 47.3:
            return 2
        ...
        if (1950 <= weight <= 2550) and arm < 41:
            a = weight - 1950
            b = arm - 35
            c = 100 * b
            if a <= c:
    ...
    def time_util(self, to, ldg):
        ...
        top_int = (2200 - y_int) / slope  # the arm when weight is the upper limit of the utility category
    ...
    def create_graph(self, mod_title=None):
        ...
        right_x = [47.3, 47.3]
        right_y = [1500, 2550]
        top_util_x = [37.5, 40.5]
        top_util_y = [2200, 2200]
        right_util_x = [40.5, 40.5]
        right_util_y = [1500, 2200]
