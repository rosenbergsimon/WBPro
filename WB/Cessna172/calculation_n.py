...
class CalculationN:
    def __init__(self, data):
        ...
        if self.data['ident'] == "C-GBGV":
            self.fuel_arm = 48
            self.empty_weight = 1455.38
            self.empty_arm = 39.58
    ...
    def check_wb(self):
        ...
        if self.ramp_weight > 2307:
            ramp_weight_good = False
        if self.takeoff_weight > 2300:
    ...
    def check_in_limits(self, weight, arm):
        ...
        if weight < 1950 and arm < 35:
            return 0
        if (1950 <= weight <= 2300) and 38.5 <= arm <= 47.3:
            return 1
        if arm > 47.3:
            return 2
        ...
        if (1950 <= weight <= 2300) and arm < 38.5:
            a = weight - 1950
            b = arm - 35
            c = 100 * b
            if a <= c:
    ...
    def time_util(self, to, ldg):
        ...
        top_int = (2000 - y_int) / slope  # the arm when weight is the upper limit of the utility category
    ...
    def create_graph(self, mod_title=None):
        ...
        right_x = [47.3, 47.3]
        right_y = [1500, 2300]
        top_util_x = [35.5, 40.5]
        top_util_y = [2000, 2000]
        right_util_x = [40.5, 40.5]
        right_util_y = [1500, 2000]
