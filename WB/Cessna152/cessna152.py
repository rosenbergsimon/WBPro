...
class C152(tk.CTkToplevel):
    ...
    # this function point to calculation_152.py class, and does all the calculating work/making of the images. Also
    # holds functions for updating the wb images
    def calculate(self, data):
        self.data = data
        self.calculation = Calculation152(self.data)
